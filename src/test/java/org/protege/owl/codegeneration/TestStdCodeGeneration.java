...
public class TestStdCodeGeneration {
    ...
    public void testSimpleCreate() throws Exception {
        MySimpleStdFactory factory = TestUtilities.openFactory(TestUtilities.ONTOLOGY01,
                MySimpleStdFactory.class, false);
    ...
    public void testStringNoTypes() throws Exception {
        ...
        OWLAxiom typeAxiom = owlApiFactory.getOWLClassAssertionAxiom(
                org.protege.owl.codegeneration.std.testSimple02.Vocabulary.CLASS_A1, a1.getOwlIndividual());
