...
public class TestInferredCodeGeneration {
    ...
    public void testGenericListTypes() throws SecurityException, NoSuchMethodException {
        ...
        TestUtilities.assertReturnsCollectionOf(IriA.class.getMethod("getIriP", noArguments),
                WrappedIndividual.class);
        TestUtilities.assertReturnsCollectionOf(A1.class.getMethod("getIriP", noArguments),
                WrappedIndividual.class);
        TestUtilities.assertReturnsCollectionOf(A2.class.getMethod("getIriP", noArguments),
                WrappedIndividual.class);
    ...
    public void testDataValues01() throws Exception {
        MyInferredFactory factory = TestUtilities.openFactory(TestUtilities.ONTOLOGY01,
                MyInferredFactory.class, true);
    ...
    public void testObjectValues() throws Exception {
        ...
        assertTrue(values.size() == 1);
        assertEquals(values.iterator().next().getOwlIndividual().getIRI().toString(),
                TestUtilities.NS01 + "#y");
    }
    ...
    @Test
    public void testCreate() throws SecurityException, NoSuchMethodException, OWLOntologyCreationException,
