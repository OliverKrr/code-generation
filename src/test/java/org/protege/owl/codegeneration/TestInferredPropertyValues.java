...
public class TestInferredPropertyValues {
    ...
    @Test
    public void testInferredPropertyValues() throws SecurityException, OWLOntologyCreationException,
            IllegalArgumentException, NoSuchMethodException, InstantiationException, IllegalAccessException,
            ClassNotFoundException, InvocationTargetException {
        InferredPropertyValuesFactory factory = TestUtilities.openFactory(
                TestUtilities.PROPERTY_VALUES_ONTOLOGY, InferredPropertyValuesFactory.class, true);
    ...
    @Test
    public void testAssertedPropertyValues() throws SecurityException, OWLOntologyCreationException,
            IllegalArgumentException, NoSuchMethodException, InstantiationException, IllegalAccessException,
            ClassNotFoundException, InvocationTargetException {
        InferredPropertyValuesFactory factory = TestUtilities.openFactory(
                TestUtilities.PROPERTY_VALUES_ONTOLOGY, InferredPropertyValuesFactory.class, false);
        A i = factory.getA(TestUtilities.PROPERTY_VALUES_NS + "i");
        B j = factory.getB(TestUtilities.PROPERTY_VALUES_NS + "j");
    ...
    @Test
    public void testInferenceUpdate() throws SecurityException, OWLOntologyCreationException,
            IllegalArgumentException, NoSuchMethodException, InstantiationException, IllegalAccessException,
            ClassNotFoundException, InvocationTargetException {
        InferredPropertyValuesFactory factory = TestUtilities.openFactory(
                TestUtilities.PROPERTY_VALUES_ONTOLOGY, InferredPropertyValuesFactory.class, true);
        ...
        manager.applyChanges(
                Collections.singletonList(new AddAxiom(factory.getOwlOntology(), A_HAS_I_AXIOM)));
        Assert.assertFalse(i.getP().contains(i));
