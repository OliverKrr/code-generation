...
public class IriNames extends AbstractCodeGenerationNames {
    ...
    public IriNames(OWLOntology ontology, CodeGenerationOptions options) {
        ...
        OWLOntologySetProvider ontologySetProvider = new OWLOntologyImportsClosureSetProvider(manager,
                ontology);
        provider = new AnnotationValueShortFormProvider(annotationProperties, preferredLanguageMap,
                ontologySetProvider);
    }
