...
public class GenerateSimpleJavaCode {
    ...
    public static void main(String[] args) throws Exception {
        ...
        generateSimpleJavaCode(ontologyLocation, parsedOptions.getOptionValue(PACKAGE_OPT),
                parsedOptions.getOptionValue(FACTORY_OPT), parsedOptions.getOptionValue(REASONER_OPT),
                outputFolder);
    }
    ...
    private static void generateSimpleJavaCode(File ontologyLocation, String packageName, String factoryName,
            String reasonerFactoryName, File outputFolder) throws OWLOntologyCreationException,
        ...
        if (reasonerFactoryName != null) {
            OWLReasonerFactory rFactory = (OWLReasonerFactory) Class.forName(reasonerFactoryName)
                    .newInstance();
        ...
        LOGGER.info("Generated source code for ontology " + ontologyLocation + " ("
                + (useInference ? "inferred " : "asserted.") + "  Total time = "
