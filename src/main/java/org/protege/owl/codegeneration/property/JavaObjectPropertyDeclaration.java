...
/**
 * This class represents the following java methods that are associated with an
 * OWL object property:
 * 
 * <pre>
...
public class JavaObjectPropertyDeclaration implements JavaPropertyDeclaration {
    ...
    private String getObjectPropertyRange(boolean isInterface) {
        ...
        if (range == null || !inference.getOwlClasses().contains(range)) {
            return isInterface ? Constants.UKNOWN_CODE_GENERATED_INTERFACE
                    : Constants.ABSTRACT_CODE_GENERATOR_INDIVIDUAL_CLASS;
        }
